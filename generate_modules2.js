...
fs.writeFileSync('app/src/main/assets/js/modules/Effects.js', effectsCode);
fs.writeFileSync('app/src/main/assets/js/modules/AudioController.js', audioCode);
console.log('Effects and AudioController generated');
