...
|---|---|---|---|---|---|
| BUILD-001 | P0 | OPEN | Gradle wrapper | Wrapper scripts/properties target Gradle 9.3.1, but the binary wrapper JAR is not committed. | Supply the official wrapper artifact through a repository/PR path that accepts binary files, then rerun the wrapper commands. |
